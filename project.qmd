...
*AI usage note: Claude (Anthropic) was used to assist with data collection scripting, preprocessing of multiple data sources, code debugging, and an initial draft of the written sections. The authors reviewed, rewrote, and verified all content; all analysis interpretations and final wording belong to the authors.*
